...
const feature = loadFeature(
  "./__tests__/features/Upvotedownvote-scenario.web.feature"
);
...
defineFeature(feature, (test) => {
  ...
  test("User navigates to Upvotedownvote", ({ given, when, then }) => {
    ...
    given("I am a User loading Upvotedownvote", () => {
      exampleBlockA = shallow(<Upvotedownvote {...screenProps} />);
    });

    when("I navigate to the Upvotedownvote", () => {
      instance = exampleBlockA.instance() as Upvotedownvote;
    });
