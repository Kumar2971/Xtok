//This an auto generated file for Artboard Name = Realtimeupdates And Supports ReactNative Ver. = 0.62
...
export default class Realtimeupdates extends React.Component
{
...
const styles = {...global_styles, ...local_styles}
 	...
 	return (
		...
		<View 
				style={styles.RealtimeupdatesView}>
