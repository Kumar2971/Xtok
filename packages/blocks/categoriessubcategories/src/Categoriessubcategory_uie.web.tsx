//This an auto generated file for Artboard Name = Categoriessubcategory And Supports ReactNative Ver. = 0.62
...
export default class Categoriessubcategory extends React.Component
{
...
const styles = {...global_styles, ...local_styles}
 	...
 	return (
		...
		<View 
				style={styles.CategoriessubcategoryView}>
