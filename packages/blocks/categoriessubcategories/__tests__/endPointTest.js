...
let cmd = `cd ../../../../ && node endPointTest.js --host ${host} --path ${config.categoryAPIEndPoint} --method GET`
...
exec(cmd, (error, stdout, stderr) => {
 ...
 cmd = `cd ../../../../ && node endPointTest.js --host ${host} --path ${config.subCategoryAPIEndPoint} --method GET`
