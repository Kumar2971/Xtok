...
import CfLiveChallenges from "../../src/CfLiveChallenges.web";
...
const feature = loadFeature(
  "./__tests__/features/CfLiveChallenges-scenario.web.feature"
);
...
defineFeature(feature, (test) => {
  ...
  test("User navigates to CfLiveChallenges", ({ given, when, then }) => {
    ...
    given("I am a User loading CfLiveChallenges", () => {
      exampleBlockA = shallow(<CfLiveChallenges {...screenProps} />);
    });

    when("I navigate to the CfLiveChallenges", () => {
      instance = exampleBlockA.instance() as CfLiveChallenges;
    });
