//This an auto generated file for Artboard Name = Comments And Supports ReactNative Ver. = 0.62
...
export default class Comments extends React.Component
{
    ...
    attrbuted_textlabel_SettingsText7: {
        position: "relative",
        width: MergeEngineUtilities.deviceBasedDynamicDimension(42, true, 1),
        height: MergeEngineUtilities.deviceBasedDynamicDimension(15, false, 1),
        marginLeft: MergeEngineUtilities.deviceBasedDynamicDimension(326, true, 1),
...
const styles = {...global_styles, ...local_styles}
 	...
 	return (
		...
		/>
		<Image data-elementId='imagenav_close' 
		   style={styles.imagenav_closeImageNav}
		...
		/>
		  ...
		  <Text data-elementId='textlabel_Settings' 
			   style={styles.textlabel_SettingsText}>4.5k
		  </Text>
		...
		/>
		  ...
		  <Text data-elementId='textlabel_Settings' 
			   style={styles.textlabel_SettingsText2}>3k
		  </Text>
		...
		/>
		  ...
		  <Text data-elementId='textlabel_Settings' 
			   style={styles.textlabel_SettingsText3}>1.5k
		  </Text>
		<Image data-elementId='image_Bitmap' 
		...
		/>
		  ...
		  <Text data-elementId='textlabel_Settings' 
			   style={styles.textlabel_SettingsText4}>900
		  </Text>
		...
		/>
		  ...
		  <Text data-elementId='textlabel_Settings' 
			   style={styles.textlabel_SettingsText5}>350
		  </Text>
		  <Text data-elementId='textlabel_ViewReplies4' 
		...
		/>
		  ...
		  <Text data-elementId='textlabel_Settings' 
			   style={styles.textlabel_SettingsText6}>122
		  </Text>
		...
		/>
		  ...
		  <Text data-elementId='textlabel_Settings' 
			   style={styles.textlabel_SettingsText7}>35
		  </Text>
		<Image data-elementId='image_Bitmap' 
