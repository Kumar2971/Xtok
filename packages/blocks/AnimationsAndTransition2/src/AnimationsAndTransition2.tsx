...
import AnimationsAndTransition2Controller, {
  Props,
  configJSON,
} from "./AnimationsAndTransition2Controller";

export default class AnimationsAndTransition2 extends AnimationsAndTransition2Controller {
