...
import Gamification from "../../src/Gamification.web";
...
const feature = loadFeature(
  "./__tests__/features/Gamification-scenario.web.feature"
);
...
defineFeature(feature, (test) => {
  ...
  test("User navigates to Gamification", ({ given, when, then }) => {
    ...
    given("I am a User loading Gamification", () => {
      exampleBlockA = shallow(<Gamification {...screenProps} />);
    });

    when("I navigate to the Gamification", () => {
      instance = exampleBlockA.instance() as Gamification;
    });
