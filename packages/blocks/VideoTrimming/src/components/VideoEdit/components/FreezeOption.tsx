...
export function FreezeOption(
  props: PropsWithChildren<FreezeOptionProps>,
): ReactElement {
  const {onConfirm} = props;

  return (
    <View style={styles.container}>
      <Text style={styles.title}>Freezing only 2 seconds</Text>
      <View
        style={{
          flex: 1,
...
export interface FreezeOptionProps {
  onConfirm: () => void;
}

FreezeOption.defaultProps = {};

export default FreezeOption;
