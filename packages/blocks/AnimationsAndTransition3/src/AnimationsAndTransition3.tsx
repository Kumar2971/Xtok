...
import AnimationsAndTransition3Controller, {
  Props,
  configJSON,
} from "./AnimationsAndTransition3Controller";

export default class AnimationsAndTransition3 extends AnimationsAndTransition3Controller {
