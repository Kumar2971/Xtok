...
const screenProps = {
    ...
    id: "AudioEditor",
    route: { params: { clip: { audio: `${utils.returnS3URL()}/minio/sbucket/6idiragzyuszl0b0c5d44eaa8h2f` } }},
  }
...
defineFeature(feature, (test) => {
    ...
    test('User navigates to AudioEditor', ({ given, when, then }) => {
        ...
        when('I navigate to the AudioEditor', async() => {
             ...
             postTrimmedAudio.addData(
                getName(MessageEnum.RestAPIResponceSuccessMessage),
                {
                    "data": {
                        "id": "428",
                        "attributes": {  
                        "trim_audio":  "minio/sbucket/6idiragzyuszl0b0c5d44eaa8h2f", 
                        }
                    },
                    "meta": {
                        "message": "test"
        ...
        then('I can select the button with with out errors', () => {
           ...
           runEngine.sendMessage("Unit Test", postTrimmedAudio);
            ...
            instance.setState({ fromValue: '5', toValue: '2' });
            instance.setState({ downloadedAudio: 'audio test' });
