...
> {
  ...
  async receive(from: string, message: Message) {
    ...
    if (getName(MessageEnum.SessionResponseMessage) === message.id) {
      ...
      this.getEducationApiCallSuccess(message)
    }
    ...
    if (
      ...
      this.getProjectCallApiSuccess(message)
    }
    ...
    if (
      ...
      this.getAwardApiCallSuccess(message)
    }
    ...
    if (
      ...
      this.getpatentApiCallSuccess(message)
    }
    // Customizable Area End
  }

  // Customizable Area Start
  getEducationApiCallSuccess = (message:any) => {
  ...
  getProjectCallApiSuccess = (message:any) => {
    const resJson = message.getData(
      getName(MessageEnum.RestAPIResponceSuccessMessage)
    );
    if (resJson?.errors?.length > 0) {
  ...
  getAwardApiCallSuccess = (message:any) => {
    const resJson = message.getData(
      getName(MessageEnum.RestAPIResponceSuccessMessage)
    );
    if (resJson?.errors?.length > 0) {
  ...
  getpatentApiCallSuccess = (message:any) => {
    const resJson = message.getData(
      getName(MessageEnum.RestAPIResponceSuccessMessage)
    );
    if (resJson?.errors?.length > 0) {
