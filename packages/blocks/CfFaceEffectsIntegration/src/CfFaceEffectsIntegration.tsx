...
import CfFaceEffectsIntegrationController, {
  Props,
  configJSON,
} from "./CfFaceEffectsIntegrationController";

export default class CfFaceEffectsIntegration extends CfFaceEffectsIntegrationController {
