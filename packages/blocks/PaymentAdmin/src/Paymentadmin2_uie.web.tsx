//This an auto generated file for Artboard Name = Paymentadmin2 And Supports ReactNative Ver. = 0.62
...
export default class Paymentadmin2 extends React.Component
{
...
const styles = {...global_styles, ...local_styles}
 	...
 	return (
		...
		<View 
				style={styles.Paymentadmin2View}>
