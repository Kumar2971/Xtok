...
import CfAppCoinsManagementController, {
  Props,
  configJSON,
} from "./CfAppCoinsManagementController";

export default class CfAppCoinsManagement extends CfAppCoinsManagementController {
