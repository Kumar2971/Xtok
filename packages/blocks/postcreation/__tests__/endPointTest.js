...
const cmd1 = `cd ../../../../ && node endPointTest.js --host ${host} --path ${config.CategoryGetUrl} --method GET`
...
const cmd2 = `cd ../../../../ && node endPointTest.js --host ${host} --path ${config.getAllCatergoryEndPoint} --method GET`
...
const cmd = `cd ../../../../ && node endPointTest.js --host ${host} --path ${config.postGetUrl} --method GET`
