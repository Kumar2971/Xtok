...
export default class NotifService {
  ...
  constructor(onRegister: any, onNotification: any) {
    ...
    PushNotification.getApplicationIconBadgeNumber(function (number: any) {
      if (number > 0) {
  ...
  createDefaultChannels() {
    PushNotification.createChannel(
      {
        channelId: "LikeTikTok-channel-id", // (required)
        channelName: 'LikeTikTok channel', // (required)
        channelDescription: "A LikeTikTok channel", // (optional) default: undefined.
      ...
      (created:any) =>
        console.log(`createChannel 'LikeTikTok-channel-id' returned '${created}'`) // (optional) callback returns whether the channel was created, false means it already existed.
    );
  }
  ...
  localNotif(soundName: any, title: any, message: any, data: any) {
    this.lastId++;
    PushNotification.localNotification({
      /* Android Only Properties */
      channelId: "LikeTikTok-channel-id",
