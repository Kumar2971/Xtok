enum MessageEnum {
  ...
  NavigationPhoneNumberInputMessage,
  PhoneNumberInputDataMessage,
  HelpCentreMessageData,
  EventsMessageData,
  NavigationBottomTabScreenAdapterMessage,
  NavigationBottomTabScreenData,
  NavigationLoginMessage,
  LoginDataMessage,
  NavigationLoginSuccessMessage,
  LoginSuccessDataMessage,
  MobilePhoneLogInDataMessage,
  NavigationOTPInputAuthMessage,
  OTPInputAuthDataMessage,
  NavigationFollowersMessage,
  FollowersDataMessage
}
